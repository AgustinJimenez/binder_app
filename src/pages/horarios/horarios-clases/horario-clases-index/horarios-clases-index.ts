...
import { HorariosClasesDetallePage } from "./../../horarios-clases/horarios-clases-detalle/horarios-clases-detalle"

@IonicPage()
@Component({
  selector: 'page-horarios-clases-index',
  templateUrl: 'horarios-clases-index.html',
})
export class HorariosClasesIndexPage 
{
  ...
  public loading: any;
  public horarios_clases: Array<any> = [];
  ...
  setVariables()
  {
    ...
    //console.log("===>", this.nombre_grado_seccion);
  ...
  load_elements()
  {
    ...
    this.params = 
    {
      skip: this.horarios_clases.length,
    ...
    if( this.routes.debug )
      console.log("PARAMS=>", this.routes.horarios_clases_index_url, this.params );

    this.native_http.get( this.routes.horarios_clases_index_url , this.params, this.routes.header )
    .then(res =>
    {
      ...
      {
        for (let horario_clase of this.response.data.horarios_clases )
          this.horarios_clases.push( horario_clase );
      }
  ...
  horario_clase_was_clicked( horario_clase )
  {
    this.navCtrl.push( HorariosClasesDetallePage, { horario_clase_id: horario_clase.id } );
  }
