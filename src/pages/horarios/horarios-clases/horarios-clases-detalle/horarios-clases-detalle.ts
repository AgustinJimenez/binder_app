...
@IonicPage()
@Component({
  selector: 'page-horarios-clases-detalle',
  templateUrl: 'horarios-clases-detalle.html',
})
export class HorariosClasesDetallePage 
{

  public horario_clase_id: string;
  public horario_clase: any;
  public response: any;
  ...
  set_params()
  {
    ...
    this.params = 
    {
      id: this.navParams.get('horario_clase_id'),
  ...
  getHorarioClase()
  {
    ...
    if( this.routes.debug )
      console.log("SENDING", this.routes.horarios_clases_detalle_url, this.params);

    this.native_http.get( this.routes.horarios_clases_detalle_url, this.params, this.routes.header )
    .then(res => 
    {
        ...
        {
          this.horario_clase = this.response.data.horario_clase;
        }
        loading.dismiss();
      })
      .catch(err => {
